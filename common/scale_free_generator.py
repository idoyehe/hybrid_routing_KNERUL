...
def _getOptions(args=argv[1:]):
    ...
    parser.add_argument("-alpha", "--alpha", type=float, help="alpha", default=0.41)
    parser.add_argument("-beta", "--beta", type=float, help="beta", default=0.54)
    parser.add_argument("-gamma", "--gamma", type=float, help="gamma", default=0.05)
    parser.add_argument("-delta_in", "--delta_in", type=float, help="delta_in", default=0.2)
    parser.add_argument("-delta_out", "--delta_out", type=float, help="delta_out", default=0)
