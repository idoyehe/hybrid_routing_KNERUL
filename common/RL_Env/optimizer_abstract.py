...
class Optimizer_Abstract(object):
    ...
    def _calculating_traffic_distribution_2(self, dst_splitting_ratios, traffic_matrix):
        net_direct = self._network
        ...
        return max_congestion, most_congested_link, flows_dest_per_node, congestion_per_link, load_per_link
