...
class HistoryConsts:
    SOFTMIN_ALPHA = -2.0 #tf.constant(-2, dtype=tf.float32)
    SOFTMAX_ALPHA = 1.0 #tf.constant(-2, dtype=tf.float32)
    EPSILON = 1.0e-2 #tf.constant(1.0e-6)
    PERC_DEMAND = 0.999
    INFTY = 1.0e4 #tf.constant(1.0e4)
    ZERO = 0.0 #tf.constant(0, dtype=tf.float32)
