...
def get_optimal_load_balancing(net: ECMPNetwork, traffic_demand, verbos=0):
    ...
    if verbos > 0:
        print(lp_problem)
        print("Status: {}".format(pl.LpStatus[status]))
        for var_name, var in vars_dict.items():
            print("Value of variable: {} is: {}".format(var_name, pl.value(var)))
...
get_optimal_load_balancing(ecmpNetwork, get_flows_matrix(), verbos=1)
"""
