...
def rl_routing_graphs():
    ...
    #
    # plot_learning_convergence(
    #     "C:\\Users\\IdoYe\\PycharmProjects\\Research_Implementing\\Learning_to_Route\\TMs_DB\\ConsoleOut_gravity_10500.txt",
    #     left_limit=0,
    #     right_limit=6000,
    #     y_ticks=np.arange(1, 7, step=0.1),
    ...
    plot_learning_convergence(
        "C:\\Users\\IdoYe\\PycharmProjects\\Research_Implementing\\Learning_to_Route\\TMs_DB\\ConsoleOut_bimodal_350.txt",
        left_limit=0,
        right_limit=6000,
        y_ticks=np.arange(1, 11, step=0.2),
        title="Bimodal Sparsity 100% Elephant Rate 40%, 350 Matrices",
    ...
    plot_learning_convergence(
        "C:\\Users\\IdoYe\\PycharmProjects\\Research_Implementing\\Learning_to_Route\\TMs_DB\\ConsoleOut_bimodal_10500.txt",
        left_limit=0,
        right_limit=6000,
        y_ticks=np.arange(1, 11.2, step=0.2),
        title="Bimodal Sparsity 100% Elephant Rate 40%, 10,500 Matrices",
